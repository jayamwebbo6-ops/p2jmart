...
import { User, Package, MapPin, Heart, ShoppingCart, LogOut, Home } from 'lucide-react';
...
const AccountLayout = () => {
  const navLinks = [
    ...
    { to: '/my-account/wishlist', label: 'Wishlist', icon: <Heart size={18} /> },
    { to: '/my-account/cart', label: 'Cart', icon: <ShoppingCart size={18} /> },
  ...
  return (
    <div className="min-h-screen bg-[#fcf9f5] font-sans py-8 px-4 md:px-8 lg:px-12">
        ...
        {currentPage === 'orders' && (
          <div className="flex items-center space-x-3">
            <input 
              ...
              className="border border-gray-300 rounded-md px-3 py-1.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-full md:w-64"
            />
