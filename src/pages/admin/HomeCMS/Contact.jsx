...
const ContactSocialSettings = ({ formData = {}, setFormData, onSave, isSaving }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Pass the payload transparently so it maps accurately to your schema rules
    onSave(formData);
  };

  // Safe handler to update deeper properties without mutating existing fields
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs p-6 space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <input 
              ...
              placeholder="+91 925537662, 936675427"
            />
          ...
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-200 focus:border-slate-400 rounded-xl px-4 py-3 text-sm font-semibold text-slate-800 focus:outline-none transition-all"
              placeholder="jayamerbb06@gmail.com"
            />
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-slate-100 flex justify-end">
            <button 
              type="submit" 
              disabled={isSaving}
              className="bg-primary hover:bg-[#002B49] text-white font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-xl shadow-xs active:scale-95 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
