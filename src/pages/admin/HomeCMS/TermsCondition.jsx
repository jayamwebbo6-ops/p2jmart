...
const TermsCondition = () => {
  ...
  const handleSaveAllPolicies = () => {
    console.log("Saving policy configuration payload: ", sections);
    alert("Policy settings configuration updated locally!");
  };
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-[#002B49]">
            Terms Condition ({sections.length})
          </h1>
          <button
          ...
          {sections.map((section) => (
            ...
            >
              ...
              <div className="space-y-2 max-w-xl">
                ...
                <input
                  type="text"
                  placeholder="e.g. Title of terms and condition"
                  value={section.title}
        ...
        {sections.length > 0 && (
          <div className="flex justify-end pt-2">
            <button
              ...
              className="bg-[#00213d] hover:bg-black text-white font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-xl shadow-xs transition-all active:scale-95"
            >
              Save privacyPolicy
            </button>
          </div>
