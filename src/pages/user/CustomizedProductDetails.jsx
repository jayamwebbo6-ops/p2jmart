...
const CustomizedProductDetails = () => {
  ...
  return (
    <div className="w-full bg-white font-['Inter'] antialiased text-gray-800 selection:bg-gray-200 min-w-0 relative">
      ...
      <div className="w-full max-w-[2500px] mx-auto px-4 mt-12">
