...
const Wishlist = ({ wishlist = [], removeFromWishlist }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 xs:px-4 py-4 xs:py-8 font-sans">
      {/* Header section adjusts gracefully at lower breakpoints */}
      <div className="flex items-center justify-between mb-4 xs:mb-6 gap-2">
        <h1 className="text-lg xs:text-2xl font-bold text-primary truncate">
          My Wishlist
        </h1>
